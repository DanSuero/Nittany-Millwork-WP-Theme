...
Nittany Millwork is led by a team of dedicated researchers, installers, and industry experts who are here to make sure you get the right product, for the right purpose, right on time.
                    ...
                    <div class="col-12 col-md-auto p-0 pr-md-4 mb-3 mb-md-0 text-center">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sm-filler.png" />
                    </div>
...
Together, Jeremy and his wife Aeriel began Nittany Millwork in 2016. Jeremy grew up learning quality construction from his Dad and carries that legacy over into everything Forefront does. He can usually be found fixing something or enjoying the outdoors.
                                ...
                                <a href="#" class="btn btn-sm-solid">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <div class="w-100"></div>
...
Tim is a 1983 graduate of Penn State in Landscape Architecture and has been a Designer/Project Manager for over 30 years. He lives in the Julian area with his wife Candi. They have three kids; Josh, Jared and Alyssa. Tim enjoys time with church ministries, hunting, and any indoor/outdoor projects.
                                </p>
                                <a href="#" class="btn btn-sm-solid">Learn More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md p-0 pl-md-1">
                        <div class="row m-0">
                            <div class="col p-0">
                                ...
                                <p class="p-sm-gray mb-4">
                               <p><b>Technician</b></p>
David Gawryla was born and raised in the State College area. He attended Bald Eagle Area High School and joined the Army National Guard after graduating. He is enrolled in the Pennsylvania State University for Architectural Engineering. David has been with Forefront since early 2014.
                                </p>
                                <a href="#" class="btn btn-sm-solid">Learn More</a>
                            </div>
                        </div>
